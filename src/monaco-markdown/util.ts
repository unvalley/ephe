...
export function isInFencedCodeBlock(doc: TextDocument, lineNum: number): boolean {
  ...
  if (inCodeBlock) {
    ...
    return !(lineNum === codeBlockStart && currentLine.match(/^```/));
  }
