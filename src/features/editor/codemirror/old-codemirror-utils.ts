...
export const epheLight: Extension = [lightTheme, syntaxHighlighting(syntaxHighlightingStyle)];

export const epheDark: Extension = [darkTheme, syntaxHighlighting(syntaxHighlightingStyle)];
